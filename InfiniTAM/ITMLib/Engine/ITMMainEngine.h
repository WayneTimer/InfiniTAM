	...
	namespace Engine
	{
		...
		*/
		...
		public:
            ...
            // by Timer
            void ProcessFrame(ITMUChar4Image *rgbImage, ITMFloatImage *rawDepthImage, ITMIMUMeasurement *imuMeasurement = NULL, char* depth_file_name = NULL);  // by Timer
			//void ProcessFrame(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, ITMIMUMeasurement *imuMeasurement = NULL, char* depth_file_name = NULL);  // by Timer
